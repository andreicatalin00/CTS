public class Old_Account {
	...
	public static double calculate(Old_Account[] 	accounts)
	{
	double totalFee=0.0;
	Old_Account account;
	int temp = 365;
	...
	account=accounts[i];
	if(account.account_Type== Old_Account.PREMIUM||account.account_Type== Old_Account.SUPER_PREMIUM)
	...
	public Old_Account(double value, double rate, int account_Type) throws Exception {
		if(value<0)
			throw new Exception();
		else
		{
